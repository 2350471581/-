...
interface TransactionDao {
    ...
    @Query("SELECT * FROM transactions ORDER BY dateMillis DESC LIMIT 2000")
    ...
    @Query("SELECT COUNT(*) FROM transactions WHERE amount = :amount AND type = :type AND ABS(dateMillis - :dateMillis) < 60000")
    suspend fun countSimilarTransactions(amount: Double, type: String, dateMillis: Long): Int
